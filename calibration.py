...
_default_calibration = [[(4, 1, 0, 0), (243, 126, 0, 0), (486, 251, 0, 0), (729, 373, 0, 0), (973, 481, 0, 0)], [(7, 4, 0, 2), (245, 161, 0, 53), (464, 305, 0, 110), (712, 468, 0, 133), (950, 600, 0, 176)], [(6, 4, 0, 4), (224, 194, 0, 188), (460, 390, 0, 355), (670, 554, 0, 502), (950, 750, 0, 656)], [(6, 4, 0, 7), (193, 177, 0, 265), (383, 345, 0, 493), (588, 512, 0, 707), (833, 691, 0, 903)], [(4, 1, 0, 15), (186, 280, 55, 227), (347, 497, 100, 469), (525, 715, 150, 693), (759, 944, 201, 858)], [(3, 2, 1, 13), (149, 252, 64, 272), (294, 473, 127, 515), (456, 695, 191, 682), (660, 917, 255, 910)], [(2, 2, 2, 14), (131, 270, 106, 238), (260, 507, 206, 475), (392, 718, 295, 712), (523, 897, 380, 950)], [(0, 1, 2, 11), (125, 291, 137, 237), (251, 547, 264, 475), (370, 765, 378, 712), (502, 927, 477, 950)]]
...
_colorpoints = pysaver.load("colorpoints", _default_calibration, True)
lamp_calibration = convert_calib(_colorpoints)

if _colorpoints == _default_calibration:
    print("Default calibration loaded")
else:
